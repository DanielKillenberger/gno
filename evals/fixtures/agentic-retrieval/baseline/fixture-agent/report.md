...
Canonical fingerprint: `7b925a55833b5107593749d49f0e0367317404a01d0014903b8a485edc3b08fc`
...
- `capsule`: `9c4a65f08850a70ff6d2ec6fe069b4cd38c9cbf3481583afd76a74264cf0591a` (corpus `68027bb0248c09507dbdba9d8cf2433f1b9b7b547ba5db8811db338982f9d08b`, preparation 703.015 ms)
- `gno-mcp`: `9c4a65f08850a70ff6d2ec6fe069b4cd38c9cbf3481583afd76a74264cf0591a` (corpus `68027bb0248c09507dbdba9d8cf2433f1b9b7b547ba5db8811db338982f9d08b`, preparation 3970.417 ms)
- `lexical`: `9c4a65f08850a70ff6d2ec6fe069b4cd38c9cbf3481583afd76a74264cf0591a` (corpus `68027bb0248c09507dbdba9d8cf2433f1b9b7b547ba5db8811db338982f9d08b`, preparation 179.981 ms)
...
| ----------------- | -------------------------------------------------------- | ------------------------------------------------------------------ | --------------------- | ----------------- | --------------------- |
| capsule/cold      | 12.907 ms / null 0                                       | 0.000 ms / null 24 (one or more model-load components unavailable) | 28.549 ms / null 0    | 1.413 ms / null 0 | 54.749 ms / null 0    |
| capsule/warm      | 0.000 ms / null 24 (completed before scored warm cohort) | 0.000 ms / null 24 (completed before scored warm cohort)           | 14.779 ms / null 0    | 0.596 ms / null 0 | 17.724 ms / null 0    |
| gno-mcp/cold      | 3393.946 ms / null 0                                     | 0.000 ms / null 24 (one or more model-load components unavailable) | 31860.314 ms / null 0 | 2.812 ms / null 0 | 35416.814 ms / null 0 |
| gno-mcp/warm      | 0.000 ms / null 24 (completed before scored warm cohort) | 0.000 ms / null 24 (completed before scored warm cohort)           | 21603.767 ms / null 0 | 2.987 ms / null 0 | 21619.034 ms / null 0 |
| lexical/cold      | 26.471 ms / null 0                                       | 0.000 ms / null 24 (one or more model-load components unavailable) | 17.364 ms / null 0    | 1.369 ms / null 0 | 57.082 ms / null 0    |
| lexical/warm      | 0.000 ms / null 24 (completed before scored warm cohort) | 0.000 ms / null 24 (completed before scored warm cohort)           | 9.350 ms / null 0     | 1.006 ms / null 0 | 16.330 ms / null 0    |
